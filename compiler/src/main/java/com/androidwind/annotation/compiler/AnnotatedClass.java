...
class AnnotatedClass {
    private static class TypeUtil {
        static final ClassName BINDER = ClassName.get("com.androidwind.knifer.api", "ViewBinder");
        static final ClassName PROVIDER = ClassName.get("com.androidwind.knifer.api", "ViewFinder");
    }
